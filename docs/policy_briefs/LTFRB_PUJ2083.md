# Route2Zero 2.0 validation brief: BACLARAN - DASMARINAS B BAYAN
...
- Priority: **#3 / 1,522**, score **76.7/100**.
- Evidence: **C**, 37.3/100.
- Rank stability: **100% top-10 frequency** across 5,000 policy scenarios; P10-P90 rank **#3-#3**.
- Climate range: **-1096 to 2982 tCO2e/year** under low/high planning assumptions. This is a scenario, not a measured reduction.
- Electricity requirement: **10895 to 13316 kWh/day** under the tested service-electrification assumptions.
...
- Equity: **73.6/100**, population-exposure proxy only. No informal-settlement status is inferred.
- Charging evidence: **56.3/100**; nearest mapped substation 0.6 km; utility capacity **not verified**.
- Operator: **50.0/100**, `NEUTRAL_PRIOR`.
- Corridor type: **Dense Urban Trunk**; typology does not add hidden policy points.

## What to validate first

1. **Climate Assumptions** - tested swing up to 1407 rank positions.
