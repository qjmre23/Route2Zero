# Route2Zero validation brief: Dasmarinas Resettlement Area - Baclaran via Coastal Rd.
...
- Priority: **#2 / 1,522**, score **76.9/100**.
- Evidence: **C**, 38.3/100.
- Rank stability: **100% top-10 frequency** across 5,000 policy scenarios; P10-P90 rank **#2-#2**.
- Climate range: **-1104 to 3004 tCO2e/year** under low/high planning assumptions. This is a scenario, not a measured reduction.
- Electricity requirement: **10977 to 13416 kWh/day** under the tested service-electrification assumptions.
...
- Equity: **73.3/100**, population-exposure proxy only. No informal-settlement status is inferred.
- Charging evidence: **56.1/100**; nearest mapped substation 0.2 km; utility capacity **not verified**.
- Operator: **50.0/100**, `NEUTRAL_PRIOR`.
- Corridor type: **Dense Urban Trunk**; typology does not add hidden policy points.

## What to validate first

1. **Climate Assumptions** - tested swing up to 1409 rank positions.
