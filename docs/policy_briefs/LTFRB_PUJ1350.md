...
- Priority: **#10 / 1,522**, score **72.5/100**.
- Evidence: **C**, 38.3/100.
- Rank stability: **32% top-10 frequency** across 5,000 policy scenarios; P10-P90 rank **#10-#18**.
- Climate range: **-983 to 2674 tCO2e/year** under low/high planning assumptions. This is a scenario, not a measured reduction.
- Electricity requirement: **9771 to 11942 kWh/day** under the tested service-electrification assumptions.
...
- Equity: **71.9/100**, population-exposure proxy only. No informal-settlement status is inferred.
- Charging evidence: **58.5/100**; nearest mapped substation 1.3 km; utility capacity **not verified**.
- Operator: **50.0/100**, `NEUTRAL_PRIOR`.
- Corridor type: **Dense Urban Trunk**; typology does not add hidden policy points.

## What to validate first

1. **Climate Assumptions** - tested swing up to 1359 rank positions.
