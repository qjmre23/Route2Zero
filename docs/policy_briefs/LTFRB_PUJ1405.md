# Route2Zero 2.0 validation brief: Bagong Silang - Philcoa via Commonwealth Ave., Maligaya Park
...
- Priority: **#17 / 1,522**, score **70.3/100**.
- Evidence: **C**, 37.3/100.
- Rank stability: **17% top-10 frequency** across 5,000 policy scenarios; P10-P90 rank **#9-#24**.
- Climate range: **-813 to 2211 tCO2e/year** under low/high planning assumptions. This is a scenario, not a measured reduction.
- Electricity requirement: **8081 to 9876 kWh/day** under the tested service-electrification assumptions.
...
- Equity: **86.0/100**, population-exposure proxy only. No informal-settlement status is inferred.
- Charging evidence: **56.3/100**; nearest mapped substation 1.6 km; utility capacity **not verified**.
