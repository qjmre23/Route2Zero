# Route2Zero validation brief: EDSA/Shaw Central - Morong via Antipolo, Theresa
...
- Priority: **#9 / 1,522**, score **72.1/100**.
- Evidence: **C**, 37.3/100.
- Rank stability: **72% top-10 frequency** across 5,000 policy scenarios; P10-P90 rank **#9-#13**.
- Climate range: **-949 to 2583 tCO2e/year** under low/high planning assumptions. This is a scenario, not a measured reduction.
- Electricity requirement: **9437 to 11534 kWh/day** under the tested service-electrification assumptions.
...
- Equity: **71.8/100**, population-exposure proxy only. No informal-settlement status is inferred.
- Charging evidence: **64.1/100**; nearest mapped substation 0.3 km; utility capacity **not verified**.
- Operator: **50.0/100**, `NEUTRAL_PRIOR`.
- Corridor type: **Dense Urban Trunk**; typology does not add hidden policy points.

## What to validate first

1. **Climate Assumptions** - tested swing up to 1303 rank positions.
